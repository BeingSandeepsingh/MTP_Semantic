...
#(
    ...
    ///////custom Signals
    output logic        cnn_en_ex_o,
    output logic [2:0]  cnn_opcode_ex_o
  ...
  cv32e40p_decoder #(
      ...
      //Custom Signal Instantiation
      .cnn_en_o    (cnn_en),
      .cnn_opcode_o(cnn_opcode)
