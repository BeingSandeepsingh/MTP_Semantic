...
////////////////////////////////////////////////////////////////////////////////
    ...
    (
      ...
      //custom Signals
      output logic        cnn_en_o,       // rename for clarity
      output logic [2:0]  cnn_opcode_o    // 3-bit funct3
      ...
      //test_tag_con
        ...
        // cnn.load_input  : funct3=101, funct7=0000_000
// cnn.load_input : funct3=101, funct7=0000_000
else if (instr_rdata_i[14:12] == 3'b101 && 
         instr_rdata_i[31:25] == 7'b0000_000) begin
    cnn_en_o     = 1'b1;
    cnn_opcode_o = 3'b001;
    alu_en       = 1'b0;
    rega_used_o  = 1'b1;   // rs1 = input_base_addr
end

// cnn.load_weight : funct3=101, funct7=0000_001
else if (instr_rdata_i[14:12] == 3'b101 && 
         instr_rdata_i[31:25] == 7'b0000_001) begin
    cnn_en_o     = 1'b1;
    cnn_opcode_o = 3'b010;
    alu_en       = 1'b0;
    rega_used_o  = 1'b1;   // rs1 = weight_base_addr
end

// cnn.conv : funct3=101, funct7=0000_010
else if (instr_rdata_i[14:12] == 3'b101 && 
         instr_rdata_i[31:25] == 7'b0000_010) begin
    cnn_en_o           = 1'b1;
    cnn_opcode_o       = 3'b011;
    alu_en             = 1'b0;
    rega_used_o        = 1'b1;          // rs1 = input_base_addr
    regb_used_o        = 1'b1;          // rs2 = output_base_addr
    regc_used_o        = 1'b1;          // rd  = dilation
    regc_mux_o         = REGC_RD;       // ← FIX 1: read rd field
    alu_op_c_mux_sel_o = OP_C_REGC_OR_FWD; // ← FIX 2: route to operand_c
end
            else
                illegal_insn_o = 1'b1;
        end
